...
<img src={Geeks}  style={{    transform: 'scale(1)',
    ...
    <div className="i-right">
     ...
     <a href="https://drive.google.com/drive/folders/1RhfrV_p2JMCCNyJsCex27voLn6a7QusH?usp=sharing"> <FloatingDiv image= {Crown} txt1 = 'Web' txt2='Developer'/></a> 
      ...
      <a href="https://drive.google.com/drive/folders/1hlUXrNBNj-Pyaq7W2cRXaLCbSco8vSB2?usp=sharing"><FloatingDiv image= {thumbup} txt1 = 'AI/ML' txt2='Enthusiast'/>
</a>
      </motion.div>
